...
namespace DJM.Utilities.MeshGeneration
{
    internal static class MarchingSquaresMeshGenerator
    {
        ...
        public static Mesh Generate(float nodeSize, float depth, MarchingSquareData[] gridConfig)
        {
            ...
            var yOffset = Vector3.down * Mathf.Abs(depth);
            ...
            for (var i = 0; i < gridConfig.Length; i++)
            {
                ...
                GetSquareVertices(square, yOffset, vertices, triangulationBuffer);
            }
        ...
        private static void GetSquareVertices(MarchingSquareData squareData, Vector3 depthOffset, List<Vector3> vertices, List<TriangulationData> triangulationBuffer)
        {
        ...
        private static Vector3[] GetVertices(MarchingSquareData squareData, Vector3 offset = default)
        {
            var basePosition = squareData.BasePosition;
