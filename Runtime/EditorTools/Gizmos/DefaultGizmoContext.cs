...
namespace DJM.Utilities.EditorTools.Gizmos
{
    internal class DefaultGizmoContext : IGizmoContext
    {
        ...
        public IGizmoContext DrawBezierCurve(Vector3 p0, Vector3 p1, Vector3 p2, Vector3 p3, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(CubicBezierCurve curve, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(Vector2 p0, Vector2 p1, Vector2 p2, Vector2 p3, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(CubicBezierCurve2D curve, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(Vector3 p0, Vector3 p1, Vector3 p2, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(QuadraticBezierCurve curve, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(Vector2 p0, Vector2 p1, Vector2 p2, int? segmentResolution = null) => this;
        public IGizmoContext DrawBezierCurve(QuadraticBezierCurve2D curve, int? segmentResolution = null) => this;
