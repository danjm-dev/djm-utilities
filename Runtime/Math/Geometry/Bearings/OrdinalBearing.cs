...
namespace DJM.Utilities.Math.Geometry
{
    ...
    public static class OrdinalBearingExtensions
    {
        ...
        [BurstCompile]
        public static Bearing AsFullBearing(this OrdinalBearing bearing)
        {
    ...
    public static class OrdinalBearingFlagsExtensions
    {
        ...
        [BurstCompile]
        public static bool Any(this OrdinalBearingFlags bearingFlags)
        {
            return bearingFlags != OrdinalBearingFlags.None;
        }
