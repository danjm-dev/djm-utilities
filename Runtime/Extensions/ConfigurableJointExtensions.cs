...
namespace DJM.Utilities.Extensions
{
    public static class ConfigurableJointExtensions
    {
        ...
        )
        {
            ...
            if (space == Space.World) resultRotation *= startRotation * Quaternion.Inverse(targetRotation);
            else resultRotation *= Quaternion.Inverse(targetRotation) * startRotation;
